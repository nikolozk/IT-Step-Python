...
def validate_input(prompt, data_type):
   ...
   # ხოლო თუ კი მომხმარებელი ცარიელს დატოვებს სათაურს ან ავტორს დააბეჭდინებს  print("შესაყვანი ველი არ უნდა იყოს ცარიელი. გთხოვთ შეავსოთ ველი.") და ხელახლა მოთხოვს ინფორმაციის შეყვანას           
            ...
            # ახდენს თარიღის შეყვანის ვალიდაციას თუ კი შესაყვანი ინფორმაცია არის რიცხვი ოთხნიშნა და ნაკლებია 2025-ზე მაშინ იგი დაამატებს ბაზაში თუარადა დაააბეჭდნებს print("შესაყვანი წელი უნდა იყოს ოთხნიშნა ციფრი.")
            if user_input.isdigit() and len(user_input) == 4 and user_input > 2025:
                return user_input
            else:
